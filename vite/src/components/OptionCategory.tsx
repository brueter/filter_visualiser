    ...
    return (
      <>
        <div className="optionCategory"
            style={{backgroundColor: `hsl(${options.color.h}, ${options.color.s}%, 90%)`, border: `1px hsl(${options.color.h}, ${options.color.s}%, 50%) solid`}}>
            ...
            {options.sliders?.map((option: any) => (
              <div key={option.name} className="sliderContainer">
                ...
                <input
                    ...
                    style={{accentColor: `hsl(${options.color.h}, ${options.color.s}%, ${options.color.l}%)`}}
                />
                <input
                    type="text"
                    value={option.value ?? 0}
